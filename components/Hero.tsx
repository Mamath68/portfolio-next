                ...
                <div className="flex justify-center flex-col w-[80%] h-[100%] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-[3rem] items-center">
                        <div>
                            ...
                            <p data-aos="fade-up" data-aos-delay="800" className="mt-[1.2rem] text-[15px] md:text-[17px]  text-[#c4cfde]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus veritatis suscipit deleniti enim veniam blanditiis ut, illo itaque dolorem, dolorum aliquid, delectus repellat voluptates? Magni eveniet quae aspernatur ullam repellendus.</p>
                            <div className="mt-[2rem] flex items-center space-x-6">
                                ...
                                <span className="relative z-10">
                                    <a href="/cv.pdf" download="mon_cv.pdf">Download CV</a>
                                </span>
                                </button>
                            </div>
                        </div>
