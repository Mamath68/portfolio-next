                    ...
                    <div>
                        ...
                        <div>
                            <h1 className="xl:text-[50px] lg:text-[40px] sm:text-[35px] text-[25px] font-semibold leading-[2.6rem] text-white">
                                Hi, I'm <span className='text-yellow-300'>Mathieu</span>
                            </h1>
                            <TypeWriteEffect />
                        </div>
                        <p className="mt-[1.2rem] text-[15px] md:text-[17px]  text-[#c4cfde]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus veritatis suscipit deleniti enim veniam blanditiis ut, illo itaque dolorem, dolorum aliquid, delectus repellat voluptates? Magni eveniet quae aspernatur ullam repellendus.</p>
